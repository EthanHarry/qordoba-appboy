  ...
  return (
    <div className="q-nav-bar">
      ...
      <div className='q-nav-item'>
        <button disabled={!props.sourceContentChanged} className='btn img-btn pull-left' onClick={props.qFileUpload} type="submit" id='q-upload-button'> Re-upload changed template to Qordoba </button>
      </div>
